...
window.onload = function(){
  ...
  function ImpressConstructor(index){
        //  var radius = 250;
        // .attr("cx", function(d, i){ return Math.sin(i+1*480 * Math.PI /180 ) * radius + width/2.05; })
      ...
      if( index == 8 || index == 16 || index == 24 || index == 32 || index == 40 || index == 48 || index == 56){
        ...
        // demarrer du centre et change disc and set scale
        // reduire la typo
        // mettre moins d'element sur un page
        //  evolution du nombre d'elemet par cercle
          // plus il y a d'element plus on démarre profond
          //pour pouvoir remonter et etre sur de tt afficher indépendament du nombre d'element
        y = 1100;
